package org.jboss.tools.gwt.customeui;
...
import org.jboss.tools.gwt.customeui.TriggerField;
...
public class HtmlEditor extends Field<String> {
    ...
    protected List<RichTextArea.FontSize> fontSizesConstants = new ArrayList<RichTextArea.FontSize>();
    ...
    public HtmlEditor() {
        super();
        disabledStyle = null;
        fontSizesConstants.add(RichTextArea.FontSize.XX_SMALL);
        fontSizesConstants.add(RichTextArea.FontSize.X_SMALL);
        fontSizesConstants.add(RichTextArea.FontSize.SMALL);
        fontSizesConstants.add(RichTextArea.FontSize.MEDIUM);
        fontSizesConstants.add(RichTextArea.FontSize.LARGE);
        fontSizesConstants.add(RichTextArea.FontSize.X_LARGE);
        fontSizesConstants.add(RichTextArea.FontSize.XX_LARGE);
        setSize(500, 300);
    ...
    public RichTextArea.BasicFormatter getBasicFormatter() {
        if (impl instanceof RichTextArea.BasicFormatter) {
            return (RichTextArea.BasicFormatter) impl;
        }
        return null;
    }
    ...
    public RichTextArea.ExtendedFormatter getExtendedFormatter() {
        if (impl instanceof RichTextArea.ExtendedFormatter) {
            return (RichTextArea.ExtendedFormatter) impl;
        }
        return null;
    }
            ...
            btnListener = new SelectionListener<ButtonEvent>() {
                ...
                public void componentSelected(ButtonEvent ce) {
                    ...
                    if (item == bold) {
                        ...
                        getBasicFormatter().setJustification(RichTextArea.Justification.LEFT);
                    } else if (item == justifyCenter) {
                        getBasicFormatter().setJustification(RichTextArea.Justification.CENTER);
                    } else if (item == justifyRight) {
                        getBasicFormatter().setJustification(RichTextArea.Justification.RIGHT);
    ...
    protected void updateStatus() {
        if (showToolbar && rendered && !GXT.isAriaEnabled()) {
            RichTextArea.BasicFormatter basic = getBasicFormatter();
            if (basic != null) {
