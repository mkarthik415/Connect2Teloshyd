	   ...
	   // add(frame);
		...
		OfficeCodeFieldBox.addListener(Events.Render, new Listener<BaseEvent>() {
			...
			public void handleEvent(BaseEvent be) {
				...
				PdfReportViewer pdf = new PdfReportViewer("/resources/Reports/report",param,"report");
				TabPanel tabPanel = Registry.get("tabPanel");
				tabPanel.getSelectedItem().close();
				TabItem item = new TabItem();
				item.setText("IRDA Report Pdf");
			...
			public void handleEvent(BaseEvent be) {
				...
				ExcelReportViewer excel = new ExcelReportViewer("/resources/Reports/report",param,"report");
				TabPanel tabPanel = Registry.get("tabPanel");
				tabPanel.getSelectedItem().close();
