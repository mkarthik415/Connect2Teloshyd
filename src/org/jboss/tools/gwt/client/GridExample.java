...
public class GridExample extends LayoutContainer {
	  ...
	  protected void onRender(Element parent, int index) {
        ...
        GridCellRenderer<Clients> buttonRenderer = new GridCellRenderer<Clients>() {  
            ...
            public Object render(final Clients model, String property, ColumnData config, final int rowIndex,  
                final int colIndex, ListStore<Clients> store, Grid<Clients> grid) {  
              if (!init) {  
                init = true;  
                grid.addListener(Events.ColumnResize, new Listener<GridEvent<Clients>>() {  
              ...
              Button b = new Button((String) model.get(property), new SelectionListener<ButtonEvent>() {  
                ...
                public void componentSelected(ButtonEvent ce) {  
                  Info.display(model.getName(), "<ul><li>" + "</li></ul>");
                  System.out.println(" "+ce.getButton().getParent());
                  TabPanel tabPanel = Registry.get("tabPanel");
                  NewClientForm newClientForm = new NewClientForm();
                  newClientForm.nameField.setValue("Karthik");
                 // homePage.addTab("Update Client", newClientForm);
...
//	    cp.setIcon(Resources.ICONS.table());
	  ...
	  public static List<Clients> getStocks() {
	    List<Clients> stocks = new ArrayList<Clients>();
	    
	    Clients c = new Clients("karthik","gemini");
	    stocks.add(c);
	    return stocks;
