...
public class SampleHomepage extends LayoutContainer
{
   ...
   public void Createhomepage()
   {
       ...
       // setLayout(layout);
        ...
        lc.add(getBanner(),northData); 
       // lc.add(getMenuBar(), menubarLayoutData);
        lc.add(getLeftSidebar(), leftSidebarLayoutData);
        lc.add(getRightSidebar(), rightSidebarLayoutData);
