...
public class PdfReportViewerForClient extends FormPanel{
	
	 public PdfReportViewerForClient(String fileName, Map<String, Object> param, String title)
	    {
			...
			.getPdfReportForClient(fileName, param, new AsyncCallback<String>()  {
